<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="传感器序号" prop="sensorId">
        <el-input
          v-model="queryParams.sensorId"
          placeholder="请输入传感器序号"
          clearable
      ...
      <el-form-item label="功能" prop="function1">
        <el-input
          v-model="queryParams.function1"
          placeholder="请输入功能"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="connectionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="传感器序号" align="center" prop="sensorId" />
      <el-table-column label="设备序号" align="center" prop="deviceId" />
      <el-table-column label="序列号" align="center" prop="serialNumber" />
      <el-table-column label="功能" align="center" prop="function1" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="传感器序号" prop="sensorId">
          <el-input v-model="form.sensorId" placeholder="请输入传感器序号" />
        </el-form-item>
        <el-form-item label="设备序号" prop="deviceId">
          <el-input v-model="form.deviceId" placeholder="请输入设备序号" />
        </el-form-item>
        <el-form-item label="序列号" prop="serialNumber">
          <el-input v-model="form.serialNumber" placeholder="请输入序列号" />
        </el-form-item>
        <el-form-item label="功能" prop="function1">
          <el-input v-model="form.function1" placeholder="请输入功能" />
        </el-form-item>
      </el-form>
...
<script>
import { listConnection, getConnection, delConnection, addConnection, updateConnection } from "@/api/system/connection";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除连接表编号为"' + ids + '"的数据项？').then(function() {
